...
#define FLASH_IMAGE_SIZE                                                       \
  (uint32_t)(FLASH_SIZE - (ApplicationAddress - 0x08000000))
...
// #define NFCT2_MAX_NDEFFILE \
//   (NFCT2_MAX_TAGMEMORY - NFCT2_MAX_CC_SIZE - NFCT2_MAX_CONFIG)
...
#define NFC_DEVICE_MAX_NDEFMEMORY NFC_TAG_MEMORY
/* Exported macro ------------------------------------------------------------*/
/* Common routines */
/* Exported functions ------------------------------------------------------- */
